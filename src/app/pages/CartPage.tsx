        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <AuthForms
            ...
            description={isAuthLoading
              ? "Проверяем, есть ли уже вход в аккаунт. Формы входа и регистрации доступны сразу: без аккаунта заказать очки нельзя, потому что заказ должен быть привязан к покупателю, телефону, email и истории покупок."
              : "Корзина показывает форму входа и регистрации сразу здесь: без аккаунта заказать очки нельзя, потому что заказ должен быть привязан к покупателю, телефону, email и истории покупок."
            }
          />
        </div>
      </div>
